# BATTLECARD: Oracle Health vs. Epic Systems
...
- Screenshot asset: Epic homepage
Target URL: https://www.epic.com/
Page title: Epic | ...With the patient at the heart
Capture reason: Competitor positioning and enterprise narrative contrast
Storage URL: https://zqsdadnnpgqhehqxplio.supabase.co/storage/v1/object/public/oracle-health-assets/oracle-he... _(Source: RAG)_
...
> "Oracle Health delivers the deepest clinical workflow integration in the industry, backed by Oracle's enterprise infrastructure. Unlike Epic Systems, we offer a single-vendor stack that eliminates integration complexity and reduces total cost of ownership."
...
- **Avoid**: Feature-by-feature comparisons where Epic Systems may have point advantages
...
### Landmine Questions
1. "How does Epic Systems handle data migration from legacy systems?"
...
### Evidence From RAG
- [market_research] ### Epic
- Epic tends to be understood as deeply embedded, high-control, health-system-native infrastructure with strong incumbent trust.
- Oracle Health should expect Epic comparisons to focus on imp...

...
Define coach voice, escalation rules, session guidance patterns, trust boundaries, emotion-aware coaching logic, and the cognitive architecture behind in-product coaching. Ensure coaches are state-sensitive, believable, and useful at hard moments.
...
### 1. Intake
- Receive coaching system design request with product context and athlete segments
- Identify the athlete's emotional and functional job in the moment
- Map coaching needs to session states (active, post-session, re-entry, reassessment)
- Clarify interface constraints and data availability

### 2. Analysis
- Map coaching needs to session states before writing messages
- Separate motivation, instruction, adaptation, and reassurance
- Design for high-effort, low-attention gym states
- Challenge every behavior for trust, overreach, and cognitive load
- Run context-before-content check before goal or prescription questions
- Use personal knowledge map with freshness and boundary rules

### 3. Synthesis
- Define session states, coaching intents, message rules, and silence rules
- Design escalation logic and trust boundary ladder
- Specify personal-knowledge-map rules (what to remember, freshness, boundaries)
- Separate instructional, motivational, adaptive, and reflective behaviors
- Include one trust risk and one validation plan

### 4. Delivery
- Deliver session states, coaching intents, message rules, silence rules, escalation logic, and personal-knowledge-map rules
- Separate instructional, motivational, adaptive, and reflective behaviors
- Include one trust risk and one validation plan
...
```json
{
  "task": "design_coaching_system",
  "context": {
    "product": "string",
    "athlete_segments": "array",
...
{
  "session_states": "array",
  "coaching_intents": "array",
  "message_rules": "object",
  "silence_rules": "object",
  "escalation_logic": "object",
  "knowledge_map_rules": "object",
  "trust_risk": "string",
...
- **Coach Exercise Science**: movement and exercise-science logic
- **Flow Sports Psychology / Freya Behavioral Economics**: motivational and adherence mechanics
- **Workout Session Studio**: coaching living inside a workout UI
- **Workout Program Studio**: when coach logic changes plan structure
- **Training Research Studio**: explanation quality depending on contested evidence
- **Shield Legal Compliance**: advice language approaching high-risk territory
...
- First reflective summary proving the coach understands the athlete's real life
...
### Pre-Design
- [ ] Product context and interface constraints documented
- [ ] Athlete segments identified
- [ ] Session states mapped
- [ ] Data availability assessed
- [ ] Trust boundary requirements defined

### Post-Design
- [ ] Session states and coaching intents specified
- [ ] Message rules documented per state
- [ ] Silence rules explicit
- [ ] Escalation logic defined
- [ ] Personal-knowledge-map rules with freshness and boundaries
- [ ] Instructional, motivational, adaptive, and reflective behaviors separated

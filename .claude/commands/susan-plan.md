...
!`cd /Users/mikerodgers/Startup-Intelligence-OS/susan-team-architect/backend && SUSAN_DEFAULT_COMPANY=founder-intelligence-os ./.venv/bin/python scripts/susan_cli.py shell-plan "$ARGUMENTS"`
